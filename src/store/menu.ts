...
const presetList = [
  ...
  },
  {
    ...
    badge: '',
    target: '_self',
    path: '/workplace/template/design',
  ...
  },
  {
    ...
    badge: '',
    target: '_self',
    path: '/workplace/system_settings',
  ...
  },
  {
    ...
    component: '@/pages/report_approve',
    renderMenu: false,
    parent: null,
    permission: null,
    cacheable: false,
