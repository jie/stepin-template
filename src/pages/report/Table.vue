...
import Report from "@/components/report_designer/index.vue"
import { ref } from "vue"
const items = [
  ...
  { title: "input input", desc:"input desc", type: "input", key: "2" },
  { title: "table input", desc:"table desc", type: "table", key: "3" },
]
