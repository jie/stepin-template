...
const onClickOpenReportSettingDrawer = () => {
  ...
  let mySettings = {
    ...
    MultipleLanguage: reportTemplateStore.reportTemplate.settings?.MultipleLanguage === undefined ? true: reportTemplateStore.reportTemplate.settings.MultipleLanguage,
